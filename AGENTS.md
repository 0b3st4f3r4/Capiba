...
This file was generated by `rtk init --agent kimi`.

### Command Rewriting Rules

The following bash commands are automatically rewritten to their RTK equivalents
before execution. This reduces token consumption by 60-90% on common dev commands.
